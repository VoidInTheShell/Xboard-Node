...
func NodeSpecFromPanel(nc *panel.NodeConfig) *NodeSpec {
	...
	if nc.CertConfig != nil {
		certCfg = &config.CertConfig{
			...
			Domains:     append([]string(nil), nc.CertConfig.Domains...),
			AutoTLS:     nc.CertConfig.AutoTLS,
			AutoRenew:   nc.CertConfig.AutoRenew,
			Revision:    nc.CertConfig.Revision,
	...
	return &NodeSpec{
		...
		RuleFiles:           ruleFiles,
		FallbackSite:        fallbackSite,
		CertificateID:       nc.CertificateID,
		CertificateRefMode:  nc.CertificateRefMode,
		CertConfig:          certCfg,
		AutoTLS:             nc.AutoTLS,
		Domain:              nc.Domain,
		Cipher:              nc.Cipher,
...
func (n *NodeSpec) ToPanel() *panel.NodeConfig {
	...
	if n.CertConfig != nil {
		certCfg = &panel.CertConfig{
			...
			Domains:     append([]string(nil), n.CertConfig.Domains...),
			AutoTLS:     n.CertConfig.AutoTLS,
			AutoRenew:   n.CertConfig.AutoRenew,
			Revision:    n.CertConfig.Revision,
	...
	return &panel.NodeConfig{
		...
		CertificateRefMode:  n.CertificateRefMode,
		CertConfig:          certCfg,
		AutoTLS:             n.AutoTLS,
		Domain:              n.Domain,
		Cipher:              n.Cipher,
